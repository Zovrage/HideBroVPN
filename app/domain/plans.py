...
PLANS: dict[str, TariffPlan] = {
    ...
    "m3": TariffPlan(code="m3", title="3 месяца", days=90, price_rub=300),
    "m6": TariffPlan(code="m6", title="6 месяцев", days=180, price_rub=600),
    "m12": TariffPlan(code="m12", title="12 месяцев", days=365, price_rub=1000),
}
