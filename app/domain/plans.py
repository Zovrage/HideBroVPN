...
PLANS: dict[str, TariffPlan] = {
    ...
    "m1": TariffPlan(code="m1", title="1 месяц", days=30, price_rub=100),
    "m3": TariffPlan(code="m3", title="3 месяца", days=90, price_rub=250),
    "m6": TariffPlan(code="m6", title="6 месяцев", days=180, price_rub=550),
    "m12": TariffPlan(code="m12", title="12 месяцев", days=365, price_rub=1050),
}
